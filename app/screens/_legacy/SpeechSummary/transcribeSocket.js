...
const backendUrl = "https://0fff9na7p9.execute-api.us-west-2.amazonaws.com/api/create-transcribe-presigned-url";
...
export const startRecording = async (callback) => {
  ...
  console.log("Log what my presigned URL is " + presignedUrl);
